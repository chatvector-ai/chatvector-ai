...
const phases: Phase[] = [
  ...
  },
  {
    ...
    description:
      "Transform ChatVector into a multi-tenant, session-aware document intelligence backend. API-key auth, tenant isolation, Python SDK parity, hybrid retrieval, and the expanded frontend demo are shipped. Remaining work focuses on the Node/TypeScript SDK, distributed rate-limit storage, and frontend chat SSE wiring.",
    completedItems: [
      ...
      "Citation relevance scores/score types and response metadata",
    ...
    remainingItems: [
      ...
      "API-key lifecycle tooling (rotation, expiration)",
    ],
  },
];
